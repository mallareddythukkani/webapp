...
<div align="left" style="width:180px;border:0px solid #000;margin-left:10px;">
    ...
    <p align="center" style="border-bottom: 1px dashed #000; padding-bottom:5px; font-weight:bold;">Daily Report for ${ondate } </p>
    <br>
        <form>
		<input type="hidden" id="redirectUrl" value="${pageContext.request.contextPath}/report/dailyReport">
		</form>
